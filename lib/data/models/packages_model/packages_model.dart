...
class MonthlyPackage extends Equatable {
  ...
  final String? packageCurrency; // Rename to camelCase
  ...
  const MonthlyPackage({
    ...
    this.createdAt,
    this.updatedAt,
    this.packageCurrency, // Rename to camelCase
  });
  ...
  factory MonthlyPackage.fromJson(Map<String, dynamic> json) {
    return MonthlyPackage(
      ...
      packageCurrency: json['package_currency']?.toString(), // Convert to String if needed
    );
  }
  ...
  List<Object?> get props => [
        ...
        createdAt,
        updatedAt,
        packageCurrency, // Rename to camelCase
      ];
}
