  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ServiceMapCubit, ServiceMapState>(
      builder: (context, state) {
        ...
        return state
                is UpdateStateMarker // You can replace this with state checks if needed
                ...
                children: [
                  GoogleMap(
                    ...
                    onTap: (latLng) {
                      ...
                      cubit.collapseAllClusters();
                    },
                    onCameraMove: (CameraPosition position) {
                      // cubit.debouncedGetVisibleMarkers();
                    },
                    onCameraIdle: () {
                      // cubit.getVisibleMarkers();
                      // cubit.autoExpandClusters();
                    },
                    compassEnabled: true,
