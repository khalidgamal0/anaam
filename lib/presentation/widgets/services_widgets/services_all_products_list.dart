              ...
              : cubit.selectedServicesValue!.type == ServicesTypeEnum.laborers.name
                  ...
                  : cubit.selectedServicesValue!.type == "all" // All category condition
                      ? ListView.separated(
                          ...
                          itemCount: cubit.vetsList.length +
                            ...
                            return InkWell(
                              onTap: () {
                                if (service is VetModel) {
                                  Navigator.push(context, MaterialPageRoute(builder: (_) {
                                    return VetServiceDetailsScreen(vetModel: service);
                                  }));
                              ...
                              child: service is VetModel
                                  ...
                                  : service is LaborerModel
                                      ? LaborerServicesWidget(laborerModel: service)
                                      : service is StoreDataModel
                                          ? StoreServicesWidget(storeDataModel: service)
