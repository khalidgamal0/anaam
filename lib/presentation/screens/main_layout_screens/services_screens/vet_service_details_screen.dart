              ...
              children: [
                ...
                IconTitleWidget(
                  ...
                  title: CacheHelper.getData(key: CacheKeys.token) != null
                      ? (vetModel.phone_code != null && vetModel.phone != null
                      ? "${vetModel.phone_code!.replaceAll('+', '')}${vetModel.phone!}"
                      : "الرقم غير متاح")
                      : "يرجي تسجيل الدخول لعرض الرقم",
                ),
                const CustomSizedBox(
                  height: 16,
                ),
                IconTitleWidget(
                  ...
                  title: CacheHelper.getData(key: CacheKeys.token) != null 
                      ? (vetModel.vendor != null && vetModel.vendor!.email != null 
                          ? vetModel.vendor!.email! 
                  ...
                  children: [
                    if (CacheHelper.getData(key: CacheKeys.token) != null) // Check if user is logged in
                      Expanded(
                        child: CustomElevatedButton(
                          ...
                          onPressed: () {
                            final vetLink = '${EndPoints.siteUrl}veterinarians/${vetModel.id}';
                            launchWhatsApp(
                              phone: "${vetModel.phone_code?.replaceAll('+', '')}${vetModel.phone}",
                    ...
                    Expanded(
                      child: CustomElevatedButton(
                        ...
                        onPressed: () {
                          final vetLink = '${EndPoints.siteUrl}veterinarians/${vetModel.id}';
                          final String shareText = "تحقق من هذه الخدمة البيطرية:\n $vetLink";
