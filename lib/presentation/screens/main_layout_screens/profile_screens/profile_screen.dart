import 'dart:io';
import 'package:an3am/presentation/widgets/bottom_sheets_widgets/auht_register_type_bottom_sheet.dart';
                    ...
                    if (token == null && Platform.isIOS)
                      SocialAuthButton(
                        ...
                        onPressed: () {
                          showModalBottomSheet(
                            context: context,
                            builder: (_) => const AuthRegisterTypeBottomSheet(socialType: 'a',),
                          );
                        },
                      ).symmetricPadding(horizontal: 27),
