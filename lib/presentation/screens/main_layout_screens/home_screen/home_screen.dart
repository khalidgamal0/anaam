...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (cubit_ProfileCubit.profileModel != null && CacheHelper.getData(key: CacheKeys.token) != null) {
      cubit_ProfileCubit.firstNameController.text = cubit_ProfileCubit.profileModel!.firstName ?? "";
      cubit_ProfileCubit.secondNameController.text = cubit_ProfileCubit.profileModel!.lastName ?? "";
      cubit_ProfileCubit.emailController.text = cubit_ProfileCubit.profileModel!.email ?? "";
      cubit_ProfileCubit.phoneController.text = cubit_ProfileCubit.profileModel!.phone ?? "";
    }
  }
  ...
  void updateVisibleProductIds(String ids) {
    ...
    if (isMap && visibleProductIds.isNotEmpty) {
      ...
      ProductsCubit.get(context).getAllProducts(mapids: visibleProductIds); // Use dynamic IDs
      setState(() {});
    }
  }
      ...
      body: SafeArea(
        child: NestedScrollView(
          headerSliverBuilder: (_, isScrolled) => [
            ...
            SliverToBoxAdapter(
              child: SearchBarAndServicesButtonsWidget(mapButton: appearMapButton),
            )
          ],
          body: Stack(
                  ...
                  Column(
                    children: [
                      ...
                      Expanded(
                        child: isMap
                            ? HomeGoogleMapsView(
                                productsList: ProductsCubit.get(context).getFilteredProducts(),
                                onVisibleIdsChanged: updateVisibleProductIds, // Pass callback
                              )
                            : isFollowingTap &&
                        ...
                        child: BlocConsumer<ServicesCubit, ServicesState>(
                          ...
                          builder: (context, state) {
                            ...
                            return TabBarView(
                              ...
                              physics: CacheHelper.getData(key: CacheKeys.token) != null
                                  ? const AlwaysScrollableScrollPhysics()
                                  : const NeverScrollableScrollPhysics(),
                              children: [
                                // First tab: All products list
                                cubit.selectedServicesValue != null
                                    ? ServicesAllProductsList()
                                    : const Center(child: CircularProgressIndicator.adaptive()),
                                // Second tab: Following list - Only show if logged in
                ...
                child: ShowMapButton(
                  ...
                  onPressed: () async {
                    ...
                    if (!isMap) {
                      ProductsCubit.get(context).allProductsPageNumber = 1;
                      ProductsCubit.get(context).productsList.clear();
                      ProductsCubit.get(context).getAllProducts(mapids: visibleProductIds.isEmpty ? null : visibleProductIds);
                    } else {
                      ProductsCubit.get(context).allProductsPageNumber = 1;
                      ProductsCubit.get(context).productsList.clear();
                      ProductsCubit.get(context).getAllProducts();
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => Scaffold(
                      ...
                      body: Tawk(
                        directChatLink: 'https://tawk.to/chat/67db39bce170cd190fa578b2/1imo5j2rt',
                        visitor: (cubit_ProfileCubit.profileModel != null && CacheHelper.getData(key: CacheKeys.token) != null)
                            ? TawkVisitor(
                                name: '${cubit_ProfileCubit.firstNameController.text} ${cubit_ProfileCubit.secondNameController.text}',
