...
class VendorReviewsLoadingState extends ProfileState {}

class VendorReviewsLoadedState extends ProfileState {}

class VendorReviewsErrorState extends ProfileState {
  final String error;
  VendorReviewsErrorState({required this.error});
}

class UploadReviewVendorLoadingState extends ProfileState {}

class UploadReviewVendorSuccessState extends ProfileState {
  final BaseResponseModel baseResponseModel;

  UploadReviewVendorSuccessState({required this.baseResponseModel});
}

class UploadReviewVendorErrorState extends ProfileState {
  final String error;

  UploadReviewVendorErrorState({required this.error});
}

class ChangeVendorReviewRate extends ProfileState {}
