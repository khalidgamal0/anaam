import 'package:an3am/data/models/products_model/upload_or_update_product_model.dart';
...
class GetMapProductsLoadingState extends ProductsState {}

class GetMapProductsSuccessState extends ProductsState {}

class GetMapProductsErrorState extends ProductsState {
  final String error;
  GetMapProductsErrorState({required this.error});
}

class GetMainImageSuccessState extends ProductsState {}

class GetAdditionalImagesSuccessState extends ProductsState {}

class RemoveAdditionalImageSuccessState extends ProductsState {}

class ClearImagesSuccessState extends ProductsState {}
